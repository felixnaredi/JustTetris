...
static const jsShape shape_verticies[] = {
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_O, 1, 2, 2, 2, 1, 3, 2, 3) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_I, 1, 0, 1, 1, 1, 2, 1, 3) },
	{ {4, 17}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_I, 0, 2, 1, 2, 2, 2, 3, 2) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_S, 2, 1, 1, 2, 2, 2, 1, 3) },
	{ {3, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_S, 1, 2, 2, 2, 2, 3, 3, 3) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_Z, 1, 1, 1, 2, 2, 2, 2, 3) },
	{ {3, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_Z, 2, 2, 3, 2, 1, 3, 2, 3) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_L, 1, 1, 2, 1, 1, 2, 1, 3) },
	{ {4, 17}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_L, 0, 1, 0, 2, 1, 2, 2, 2) },
	{ {5, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_L, 1, 1, 1, 2, 0, 3, 1, 3) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_L, 0, 2, 1, 2, 2, 2, 2, 3) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_J, 1, 1, 2, 1, 2, 2, 2, 3) },
	{ {3, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_J, 1, 2, 2, 2, 3, 2, 1, 3) },
	{ {3, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_J, 2, 1, 2, 2, 2, 3, 3, 3) },
	{ {3, 17}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_J, 3, 1, 1, 2, 2, 2, 3, 2) },
	{ {4, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_T, 1, 1, 1, 2, 2, 2, 1, 3) },
	{ {4, 17}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_T, 1, 1, 0, 2, 1, 2, 2, 2) },
	{ {5, 16}, JS_SHAPE_VERTICIES(JS_SHAPE_FORMATION_T, 1, 1, 0, 2, 1, 2, 1, 3) },
